...
The Linear SVM correctly classified 776 of 853 test tickets and misclassified 77.

The most frequent category confusions were:
...
| Network | Software | 7 |
| Hardware | Software | 7 |
| Service Outage | Network | 6 |

<p align="center">
  <img src="docs/results/ml_confusion_matrix.png" width="80%" alt="Linear SVM ticket classification confusion matrix">
</p>

The error analysis shows that several categories overlap semantically. For example, outage tickets may also contain network or software terms, and security-related tickets may reasonably fit Network, Access, or General.

Because the labels were generated by project rules rather than independently reviewed by humans, some apparent model errors may also reflect ambiguous or noisy labels.

Generated error-analysis files:

```text
docs/results/ml_confusion_matrix.csv
